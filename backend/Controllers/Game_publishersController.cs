...
namespace backend.Controllers
{
    ...
    [ApiController]
    public class Game_publishersController : ControllerBase
    {
        private readonly video_gamesContext _context;

        public Game_publishersController(video_gamesContext context)
        {
            _context = context;
        }

        // GET: api/Game_publishers
        [HttpGet]
        ...
        public async Task<ActionResult<GamePublisher>> PostGamePublisher(GamePublisher gamePublisher)
        {
            if (_context.GamePublishers == null)
            {
                return Problem("Entity set 'video_gamesContext.GamePublishers'  is null.");
            }
